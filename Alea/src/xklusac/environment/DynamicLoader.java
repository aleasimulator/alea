        ...
        while (current_gl < total_jobs) {
            ...
            if (ev.get_tag() == AleaSimTags.EVENT_WAKE) {
                ...
                if (gl == null && current_gl < total_jobs) {
                    super.sim_schedule(GridSim.getEntityId(this.getEntityName()), 0.0, AleaSimTags.EVENT_WAKE);
                    continue;
                ...
                last_delay = delay;
                super.sim_schedule(GridSim.getEntityId("Alea_3.0_scheduler"), delay, AleaSimTags.GRIDLET_INFO, gl);
                ...
                if (current_gl < total_jobs) {
                    ...
                    super.sim_schedule(GridSim.getEntityId(this.getEntityName()), delay, AleaSimTags.EVENT_WAKE);
                }

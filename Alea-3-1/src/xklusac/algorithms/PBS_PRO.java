        ...
        for (int q = 0; q < Scheduler.all_queues.size(); q++) {
            ...
            for (int i = 0; i < curr_queue.size(); i++) {
                ...
                if (r_cand != null) {
                    ...
                    /*if(i>0 && gi.getPriority() > ((GridletInfo) curr_queue.get(0)).getPriority()){
                        System.out.println(i+"th job "+gi.getID()+" selected with bigger fairshare than 0 job, 0 = "+((GridletInfo) curr_queue.get(0)).getPriority()+" curr="+gi.getPriority());
                    }*/

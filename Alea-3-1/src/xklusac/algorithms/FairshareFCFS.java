...
public class FairshareFCFS implements SchedulingPolicy {
    ...
    public int selectJob() {
         ...
         * System.out.print(((GridletInfo)
         * Scheduler.queue.get(i)).getUser()+"("+Math.round(((GridletInfo)
         * Scheduler.queue.get(i)).getPriority())+")"+((GridletInfo)
         * Scheduler.queue.get(i)).getID()+","); }
        System.out.println("---EOF");
         */


        //System.out.println(Scheduler.queue.size()+" in queue");
        for (int i = 0; i < Scheduler.queue.size(); i++) {
